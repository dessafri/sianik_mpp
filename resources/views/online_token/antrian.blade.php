                ...
                <div class="modal-content" style="padding-bottom:0">
                    <div id="inline-form">
                        <div class="card-content">
                            <h2>Pilih Jam Kedatangan dan Harap Datang Tepat Waktu</h2>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input col s12" id="date_tab">
                                    ...
                                    <input id="datetime" name="date" type="datetime-local" value=""
                                        data-error=".datetime">
                                </div>
                                <input type="hidden" name="email" id="email" value="<?= $email ?>">
                                <input type="hidden" name="phone" id="phone" value="<?= $phone ?>">
                                <input type="hidden" name="idSimadu" id="idSimadu" value="<?= $idSimadu ?>">
                                ...
                                <input type="hidden" name="q" id="tokenq" value="<?= $tokenq ?>">
                            </div>
                        </div>
                    </div>
                </div>
